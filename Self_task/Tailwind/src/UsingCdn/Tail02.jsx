...
export default function Tail02() {
  return (
    <div>
      <div className="flex gap-2 border-b border-red-900 sm:flex-wrap gap-5 md:flex-nowrap gap-1">
        <div class="flex font-sans ">
          <div class="flex-none w-56 relative">
            <img
              src="https://i.pinimg.com/originals/8d/2c/da/8d2cda486dbcc66e0f0e552509b20357.jpg"
              alt=""
